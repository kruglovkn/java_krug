...
public class SoapHelper {
    ...
    public IssueData getIssue(int issureId) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        IssueData issue = mc.mc_issue_get(app.getProperty("web.adminLogin")
                ,app.getProperty("web.adminPassword"),(new BigInteger(String.valueOf(issureId))));
        return issue;
    }
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        return new Issue().withId(createdIssueData.getId().intValue()).withSummery(createdIssueData.getSummary())
